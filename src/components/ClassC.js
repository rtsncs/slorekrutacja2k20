...
const ClassC = () => {
  return (
    <div id="content">
      <h1>KLASA 1C - MAT-FIZ-INF</h1>
      <h2>Powinieneś wybrać klasę o takim nachyleniu przedmiotowym, jeśli:</h2>
      <li>
        marzysz o studiach informatycznych, matematycznych, fizycznych,
        architekturze, budownictwie, automatyce, robotyce, budownictwie,
        elektrotechnice, transporcie morskim, astronomii, na takich uczelniach
        jak SGGW, AGH, Politechnika Warszawska i Politechnika Wrocławska,
        Politechnika Rzeszowska, Akademia Ekonomiczna; jesteś ciekawy
        laboratoryjnych zajęć na KUL-u z fizyki;
      </li>
      <li>
        marzysz, by zmierzyć się z najlepszymi w konkursach matematycznych,
        fizycznych i informatycznych, np.: w Podkarpackim Konkursie
        Matematycznym im. Franciszka Leji, Ogólnopolskiej Olimpiadzie Fizycznej,
        w Ogólnopolskiej Olimpiadzie o Diamentowy Indeks AGH; chętnie pracujesz
        przy komputerze;
      </li>
      <li>
        w przyszłości chcesz przystąpić do egzaminu maturalnego z matematyki,
        fizyki, informatyki na poziomie rozszerzonym.
      </li>
      ...
      <table class="tg">
        ...
        <tbody>
          ...
          <tr>
            <td class="tg-t1">1C</td>
            <td class="tg-t1">matematyka R</td>
            <td class="tg-t11">2</td>
            <td class="tg-t11">2</td>
            <td class="tg-t11">3</td>
            <td class="tg-t11">3+1</td>
            <td class="tg-t12">10+1</td>
            <td class="tg-t13">360+30</td>
          </tr>
          <tr>
            <td class="tg-t14">1C</td>
            <td class="tg-t14">fizyka R</td>
            <td class="tg-t4">1</td>
            <td class="tg-t4">2</td>
            <td class="tg-t4">2</td>
            <td class="tg-t4">3+1</td>
            <td class="tg-t12">8+1</td>
            <td class="tg-t13">288+30</td>
          </tr>
          <tr>
            <td class="tg-t14">1C</td>
            <td class="tg-t14">informatyka R</td>
            <td class="tg-t4">1</td>
            <td class="tg-t4">1</td>
            <td class="tg-t4">2</td>
            <td class="tg-t4">3+1</td>
