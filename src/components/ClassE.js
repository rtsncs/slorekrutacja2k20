...
const classE = () => {
  return (
    <div id="content">
      ...
      <li>
        interesują Cię takie kierunki studiów jak geodezja, geoinformatyka,
        gospodarka przestrzenna, budownictwo, ochrona środowiska, turystyka i
        rekreacja;
      </li>
      <li>
        marzysz o studiowaniu na AGH, SGGW, Politechnice Krakowskiej,
        Politechnice Warszawskiej, Politechnice Wrocławskiej, Akademii
        Ekonomicznej;
      </li>
      <li>
      ...
      <table class="tg">
        ...
        <tbody>
          ...
          <tr>
            <td class="tg-t1">1D</td>
            <td class="tg-t1">geografia R</td>
            <td class="tg-t11">1</td>
            <td class="tg-t11">1</td>
            <td class="tg-t11">2</td>
            <td class="tg-t11">4+1</td>
            <td class="tg-t12">8+1</td>
            <td class="tg-t13">288+30</td>
          </tr>
          <tr>
            <td class="tg-t14">1D</td>
          ...
          <tr>
            <td class="tg-t14">1D</td>
            <td class="tg-t14">matematyka R</td>
            <td class="tg-t4">2</td>
            <td class="tg-t4">3</td>
            <td class="tg-t4">3</td>
            <td class="tg-t4">2+1</td>
