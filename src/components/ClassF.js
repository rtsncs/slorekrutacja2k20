...
const ClassF = () => {
  return (
    <div id="content">
      <h1>KLASA 1F - GEO-BIOL-ANG</h1>
      <h2>Powinieneś wybrać klasę o takim nachyleniu przedmiotowym, jeśli:</h2>
      <ul>
        <li>
          odnosisz znaczące sukcesy w różnych dziedzinach sportu (koszykówka,
          siatkówka);
        </li>
        <li>
          marzysz o rozwijaniu swoich umiejętności sportowych pod okiem
          doświadczonych trenerów;
        </li>
        <li>przeszedłeś pozytywnie testy sprawnościowe;</li>
        <li>
          marzysz o podjęciu studiów na Akademii Wychowania Fizycznego, Wyższej
          Szkole Kultury Fizycznej i Turystyki w Pruszkowie, Wyższej Szkole
          Rehabilitacji w Warszawie, Wyższej Szkole Sportowej w Łodzi, Wyższej
          Szkole Turystyki i Hotelarstwa, Wyższej Szkole– Edukacja w Sporcie w
          Bielsku-Białej.
        </li>
        <li>
          w przyszłości chcesz przystąpić do egzaminu maturalnego z geografii,
          biologii, języka angielskiego na poziomie rozszerzonym.
        </li>
      </ul>
